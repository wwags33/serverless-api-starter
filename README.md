...
* Create a node project under `api/src` to create the function.
* Add the function and it's associated events to the template.yml

Run commands like format, lint, and test from the `api/` directory.
* `npm run format`
* `npm run lint`
* `npm run test`
